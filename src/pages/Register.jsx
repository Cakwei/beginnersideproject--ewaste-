  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="relative flex h-[500px] w-[min(80%,450px)] min-w-[150px] flex-col items-center gap-[35px] bg-white pt-12 text-black shadow-2xl drop-shadow-2xl dark:bg-white dark:text-white"
      >
        <NavLink
          to="/"
